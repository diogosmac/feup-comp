...
public class Calculator/*@bgen(jjtree)*/implements CalculatorTreeConstants, CalculatorConstants {/*@bgen(jjtree)*/
  protected static JJTCalculatorState jjtree = new JJTCalculatorState();public static void main(String[] args) throws ParseException {
        ...
        System.out.println("\u005ct\u005cta=2;");
        System.out.println("\u005ct\u005ctb=3;");
        System.out.println("\u005ct\u005cta*b;");
        System.out.println("\u005cnWrite expression: ");
    ...
    void symbol(SimpleNode node) {
         ...
         if(node.id == CalculatorTreeConstants.JJTASSIGNMENT) {
                   SymbolTable.put(node.identifier, Integer.valueOf(node.val));
                   return;
                   }
        return;
  }
